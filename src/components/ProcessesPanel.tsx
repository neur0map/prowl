...
import { GitBranch, Search, Eye, Zap, Home, ChevronDown, ChevronRight, Loader2, Lightbulb, Layers } from 'lucide-react';
        ...
        <div className={`flex items-center gap-2 px-4 py-2 mx-2 rounded-lg hover:bg-hover group transition-all ${rowClass}`}>
            ...
            <button
                ...
                className={`p-1.5 rounded-md transition-all ${isFocused
                    ? 'text-[#FF9F0A] hover:text-[#FF9F0A] bg-[#FF9F0A]/15 hover:bg-[#FF9F0A]/20 border border-[#FF9F0A]/30 opacity-100'
