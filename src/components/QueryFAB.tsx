...
import { Terminal, Play, X, ChevronDown, ChevronUp, Loader2, Code, Table } from 'lucide-react';
    ...
    return (
      <button
        ...
        className="
          ...
          glass-elevated
          rounded-lg text-text-primary text-[13px]
          hover:bg-white/[0.14]
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="
                ...
                bg-accent
                rounded-md text-white text-[13px]
                hover:bg-accent-dim
